      ...
      <>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-2 float-left">
                  <div className="logo">
                    <Link to="/">
                      <img alt="Logo" src={Logo} width={56} height={50} />
                    </Link>
                  </div>
                </div>
                    ...
                    <div className="navbar-collapse collapse" id="navbar">
                      <ul className="nav navbar-nav main-nav float-right ml-auto">
                        ...
                        <li className="nav-item">
                          <a
                            className="btn btn-primary appoint-btn nav-link"
                            href="/pink/appointment"
                          >
                            Appointment
                          </a>
                        </li>
                        <li className="dropdown nav-item">
                          <a
                            className="dropdown-toggle settings-icon nav-link"
        ...
        <header className="mobile-header">
          <div className="panel-control-left">
            <a className="toggle-menu" href="#side_menu">
          ...
          <div className="sidebar-inner slimscroll">
            ...
            <ul className="mobile-menu-wrapper" style={{ display: "block" }}>
              ...
              <li
                className={`${
                  pathname === "blog" ||
                  pathname === "blog-left-sidebar" ||
                  pathname === "blog-full-width" ||
                  pathname === "blog-grid" ||
              ...
              >
                <div className="mobile-menu-item clearfix">
                  <a href="" className="menu-toggle">
                    Blog <i className="fas fa-sort-down  menu-toggle" />
                  </a>
                </div>
                <ul
                ...
                >
                  ...
                  <li>
                    <Link
                      className={`${
                        pathname === "blog-full-width" ? "active" : ""
                      }`}
                      to="/blog-full-width"
                    >
                      Full Width
              ...
              <li className={`${pathname === "appointment" ? "active" : ""}`}>
                <div className="mobile-menu-item clearfix">
                  <a href="/pink/appointment">Appointment</a>
                </div>
              </li>
