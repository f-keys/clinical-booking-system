...
import { Department_img } from "../imagepath"
              ...
              <div className="col-md-8">
                <div className="service-view">
                  <div className="service-image">
                    <img alt="" src={Department_img} className="img-fluid" />
                  </div>
              ...
              <aside className="col-md-4 sidebar-right">
                ...
                <div className="widget category-widget">
                  ...
                  <ul className="categories">
                    ...
                    <li>
                      <a href="#">Cancer Department</a>
                    </li>
                    <li>
                      <a href="#">ENT Department</a>
                    </li>
                  </ul>
                </div>
                <div className="widget contact-widget">
                  <div className="contact-wrap">
                    ...
                    <span className="contact-info">Call us for book and appointment</span> <Link className="btn btn-primary" to="/contact-us">Contact Us Now</Link>
                  </div>
                </div>
